            ...
            <div className='container'>
                <div className='text-center mb-[50px]'>
                    ...
                    <h3 className='text-big max-w-[800px] mx-auto'>
                        Правильная команда — залог успеха: мы вдохновляем друг
                        друга, достигаем большего и воплощаем мечты в
                        реальность.
                    </h3>
                </div>
                <div className='flex justify-center gap-[40px] mb-[50px]'>
                    {teamPersons.map((person, index) => (
                        <article
                            key={person.name}
                            className={`text-center ${index === 1 ? 'mt-[40px]' : ''}`}
                        >
                            ...
                            <h3 className='text-big font-extrabold'>
                                {person.name}
                            </h3>
                            <p>{person.job}</p>
                        </article>
